    ...
    return (
        <main style={{ backgroundImage: `url(${banner})` }} className='bg-no-repeat bg-cover lg:mt-10 rounded-3xl mx-4'>
            <div className='flex flex-col items-center justify-center   lg:p-36 text-center text-white'>
                <h2 className='text-xl lg:text-6xl font-bold lg:font-extrabold mt-2 mb-4 lg:mb-8 lg:mt-4 w-11/12 lg:w-full'>Find a unique cooking workshop designed specifically to suit your needs!</h2>
                <p className='mb-4 lg:mb-8 w-11/12 font-balance lg:font-bold text-sm lg:text-xl'>
